<?php
	...
	// Indicador do uso de namespaces
	use PHPMailer\PHPMailer\PHPMailer;
	use PHPMailer\PHPMailer\Exception;

	class Mensagem {
		// Classe para manipulação de novas mensagens.
		// Dados de envio:
		private $para = null;
		...
		// Verifica a validade do envio.
		public function mensagemValida(){
			if(empty($this->para) OR empty($this->assunto) OR empty($this->mensagem)){
				return false; // Envio inválido.
			}
			return true; // Envio válido.
		}
	}

	// Instância de um objeto com os atributos da nova mensagem:
	...
	// Tentativa de envio utilizando a biblioteca PHPMailer.
	try {
	    //Server settings
	    $mail->SMTPDebug = false;								// Enable verbose debug output
	    $mail->isSMTP();										// Set mailer to use SMTP
	    $mail->Host = 'smtp.your_server.com';					// Specify main and backup SMTP servers
	    ...
	    //Recipients
	    $mail->setFrom('user@email.com', 'Your Name');
